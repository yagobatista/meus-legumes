...
function mudaQtdCarrinho(pos, valor) {
    ...
    if (qtd == 0) {
        ...
        document.getElementById("subValor" + pos).innerHTML = "R$ " + arredondado;
        document.getElementsByClassName("valorTotal")[pos].innerHTML = "R$ " + arredondado;
    }
    calcularValorDoCarrinho();
}
