<div id="cadastro" class="modal fade moda" role="dialog">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Informações para a entrega</h4>
            </div>
            <div class="modal-body">
                <form id="formEnd" class="form-horizontal" method="post" action="envio.php">
                    <fieldset>
                        <!-- Text input-->
          ...
          Dinheiro
                        ...
                        <div class="modal-footer">
                            <div class="col-md-4 col-xs-6">
                                <a href="#carrinho" data-toggle="modal" data-dismiss="modal">
                                    <button type="button" data-dismiss="modal" name=\ "qtd\" class="form-control botao comprarMais ">Comprar mais</button>
                                </a>
                            </div>
                            <div class="col-md-4 col-xs-6">
                                <button type="submit" name=\ "qtd\" class="form-control botao finalizar" onclick="enviaCarrinho()">Finalizar pedido</button>
